...
public interface ProductService {
    ...
    ProductResponse getProductByIdInternal(Long id);
    PagedResponse<ProductResponse> getProductByCategoryId(Long categoryId, int page, int size, String sortBy, String sortDir);
