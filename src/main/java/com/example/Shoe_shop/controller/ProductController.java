...
public class ProductController {
    ...
    public ApiResponse<PagedResponse<ProductResponse>> getProductByCategoryId(
        ...
        PagedResponse<ProductResponse> pagedProducts =
                productService.getProductByCategoryId(categoryId, page, size, sortBy, sortDir);
